 ...
 */
import { z } from 'zod';
import { SessionStatus, AgentStatus, MessageStatus, CloneStatus, MessageRole, Priority, AttachmentType, EntityStatus, SessionType, AssistantPhase, AssistantType, SessionMode, SessionHistoryEventType, AgentModel, OrderDir, Theme, } from './enums.js';
// ===== Helper to create Zod enum from const object =====
function zEnumFromObj(obj) {
    return z.enum(Object.values(obj));
}
// ===== Enum Schemas =====
...
export const ApiListResponseSchema = (itemSchema) => z.object({
    success: z.literal(true),
