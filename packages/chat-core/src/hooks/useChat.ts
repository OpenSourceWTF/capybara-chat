...
import {
  ...
  useSessionErrorEvents,
  useSessionMessageStatusEvents,
  useSessionContextEvents,
  useSessionThinkingEvents,
...
export interface UseChatOptions {
  ...
  // Callback when tool usage finishes (e.g. to mark timeline items as complete)
  onToolEnd?: () => void;
  // Callback when thinking starts
  onThinking?: () => void;
}

export function useChat({ sessionId, onToolEnd, onThinking }: UseChatOptions) {
